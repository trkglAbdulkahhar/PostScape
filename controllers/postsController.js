...
exports.resetComments = async (req, res) => {
    try {
...
// POST /posts/edit/:id -> Process Edit
...
exports.postComment = async (req, res) => {
    try {
        ...
        const backURL = req.get('Referer') || `/posts/${req.params.id}`;
        res.redirect(backURL);

    } catch (err) {
        console.error("Comment Error:", err);
        const backURL = req.get('Referer') || '/feed';
        res.redirect(backURL);
    }
};
